    ...
    <div class="col-6" style="border: 2px solid black;">
        ...
        <div class="row q-pb-md" style="border-bottom: 1px solid black;">
            ...
            <div class="col-10 items-end flex">
                <p class="q-my-none text-end" style="font-size: 18px;"><strong>FORMATO INFORME LEGALIZACION DESPLAZAMIENTO -
                        CONTRATISTA</strong></p>
            </div>
        </div>
        ...
        <div class="row" style="border-bottom: 1px solid black;">
            <div v-for="(element, index) in mainActivities" class="col-12">
                <p class="q-my-none q-pl-md"><strong v-text="`${parseInt(index) + 1}. `" />{{ element.data || 'Actividad' }}
                </p>
            </div>
        </div>
        ...
        <div class="row" style="border-bottom: 1px solid black;">
            <p class="q-my-none q-pl-xs"><strong>EVIDENCIAS O SOPORTES:</strong> Enuncie los archivos que soportan estos
                resultados y anexe los correspondientes en este informe</p>
        </div>
        ...
        <div v-for="(element, index) in activities" class="row">
            <div v-for="(item, itemIndex) in element.items" class="col-12" style="border-bottom: 1px solid black;">
                <div class="row">
                    <div class="col-4" style="border-right: 1px solid black;">
                        <p class="q-my-none q-pl-sm"><strong v-text="`${getNumberOther()}. `" />{{ item.data || 'Actividad'
                        }}</p>
                    </div>
